...
function scene:create(event)
    ...
    -- Background
    local background = display.newImageRect(sceneGroup, "src/assets/pages/page02/page02.png", display.contentWidth, display.contentHeight)
    ...
    -- Navigation Buttons
    buttons.createPrevBlueButton(sceneGroup, "src.screens.page01")
